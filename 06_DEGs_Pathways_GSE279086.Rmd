...
sce <- readH5AD("~GSE279086_Practice/output/GSE279086_celltypist.h5ad")
...
saveRDS(seurat_obj, "~GSE279086_Practice/output/GSE279086_with_celltypist.rds")
```


```{r}
seurat_obj <- readRDS("~GSE279086_Practice/output/GSE279086_with_celltypist.rds")
...
run_mast_per_celltype_T1D_vs_Control <- function(
  ...
  outdir = "~GSE279086_Practice/output/DEG_MAST_T1D_vs_Control",
...
deg_path <- "~GSE279086_Practice/output/DEG_MAST_T1D_vs_Control"
...
write.csv(
  deg_summary,
  "~GSE279086_Practice/output/DEG_MAST_T1D_vs_Control/DEGsummary_table.csv",
  row.names = FALSE
)
```
